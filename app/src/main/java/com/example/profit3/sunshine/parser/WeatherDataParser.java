package com.example.profit3.sunshine.parser;
...
/**
 * Created by Profit3 on 27/11/2015.
 */
...
public static double getMaxTemperatureForDay(String weatherJson,int dayIndex)throws JSONException{
    JSONObject responseJsonObject=new JSONObject(weatherJson);
    JSONArray daysList= responseJsonObject.getJSONArray("list");
    JSONObject dayData=daysList.getJSONObject(dayIndex);
